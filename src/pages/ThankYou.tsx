    ...
    <section className="container-prose py-24 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground mt-6 leading-relaxed">
          Your request has been received. Our team will call you shortly to confirm the details and guide you through the next steps.
        </p>
        <div className="mt-10 inline-flex items-center gap-3 px-5 py-3 rounded-full bg-gold-soft border border-gold/30">
          <Phone className="h-4 w-4 text-gold" />
          <span className="text-sm font-medium">Expect a call from <span className="text-primary">+91 99999 99999</span> within 30 minutes</span>
        </div>
        ...
        <div className="mt-12 flex flex-col sm:flex-row gap-3 justify-center">
          <Button asChild variant="divine" size="lg"><Link to="/temples">Explore more temples <ArrowRight className="h-4 w-4" /></Link></Button>
          <Button asChild variant="outlineGold" size="lg"><Link to="/">Back to home</Link></Button>
        </div>
